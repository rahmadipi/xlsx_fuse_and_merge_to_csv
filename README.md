...
2. Add Files : Copy all the .xlsx files you want to combine and paste them directly into this new folder. Also, place the FusionTool.bat and the FusionTool folder that have required files inside (ConvertToCSV.xlsm, run_macro.vbs, and setting.txt) into the same folder.
